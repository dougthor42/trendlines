...
def create_app():
    ...
    routes.api_class.register_blueprint(routes.api, url_prefix=app.config.get("URL_PREFIX", None))
    routes.api_class.register_blueprint(routes.api_datapoint, url_prefix=app.config.get("URL_PREFIX", None))
    routes.api_class.register_blueprint(routes.api_metric, url_prefix=app.config.get("URL_PREFIX", None))
